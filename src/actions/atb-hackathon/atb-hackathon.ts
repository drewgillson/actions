  ...
  async execute(request: Hub.ActionRequest) {
    ...
    try {
      ...
      async function insertRowsAsStream() {
        ...
        const rows = [
          {amount: providedAmount, posted: '2020-02-09 01:00:00', description: 'From Looker', type: 'GIFT', this_account: accountId, other_account: '', completed: '2020-02-09 02:00:00', id: '', JID: '', random_date: '2020-02-09 03:00:00'},
        ];
        console.log(rows)
